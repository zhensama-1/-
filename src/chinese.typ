...
#resume_desc(
  "项目简介",
  "设计了一个场景重建系统，构建基于大语言模型的视觉智能体框架。系统通过生成并执行Blender程序实现 3D 场景建模，结合多视角渲染与视觉验证模块进行迭代优化，实现文本到动态场景的自动生成与空间关系推理，探索视觉理解与逆图形建模结合的智能体方法。"
)
#resume_desc(
  "项目成果",
  "在3D编辑中，该系统相比传统一次性生成模型分别提升了35%，同时，在30个挑战性的任务，涵盖相机调整、多步编辑和组合式绘图中，实现123%的性能突破。"
)
